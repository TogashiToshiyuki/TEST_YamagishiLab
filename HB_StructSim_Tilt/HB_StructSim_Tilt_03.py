...
def getTemporaryStructure(MaterName, Nmol, mol_pos, Tilt, which, RefLines, dev, dirpath, Debug, Operator,
    ...
    material configuration. If not, it generates necessary files, submits jobs,
    ...
    :type dev: float
    :param dirpath: Directory path where the files and logs are stored.
    :type dirpath: str
...
def mkFiles(MaterName, Nmol, mol_pos, Condition, Operator, dirpath, Tilt_Angle, Formated_Tilt, Flag_XYZ):
    ...
    :param str Formated_Tilt: Formatted string of the tilt angle for file naming.
